...
const STEPS: PipelineStep[] = [
  ...
  { id: 'remediate', icon: Shield, title: 'Remediate', model: 'Orchestrator', description: 'Auto-fix with approval gates',
    detail: 'Targeted remediation plans with IAM policy fixes, security group corrections, and compliance alignment.',
    color: '#4f46e5', bg: '#eef2ff', badgeClass: 'bg-indigo-100 text-indigo-700 border-indigo-200' },
